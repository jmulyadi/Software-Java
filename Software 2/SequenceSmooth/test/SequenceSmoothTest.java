...
public final class SequenceSmoothTest {
    ...
    /**
     * Test smooth with s1 = <0,0> and s2 = <-5, 13>.
     */
    @Test
    public void test3() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(0, 0);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(0, 0);
        Sequence<Integer> seq2 = this.createFromArgs(-5, 13);
    ...
    /**
     * Test smooth with s1 = <1000,0> and s2 = <-5, 12>.
     */
    @Test
    public void tes4() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(1000, 0);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(1000, 0);
        Sequence<Integer> seq2 = this.createFromArgs(-5, 12);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(500);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
    ...
    /**
     * Test smooth with s1 = <0, Integer.MAX_VALUE> and s2 = <-5, 12>.
     */
    @Test
    public void test6() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(0, Integer.MAX_VALUE);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(0,
                Integer.MAX_VALUE);
        Sequence<Integer> seq2 = this.createFromArgs(-5, 12);
        Sequence<Integer> expectedSeq2 = this
                .createFromArgs(Integer.MAX_VALUE / 2);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
